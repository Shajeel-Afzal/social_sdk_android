...
public class BaseMessagesActivity extends AppCompatActivity implements MessagesListAdapter.SelectionListener,
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        imageLoader = new ImageLoader() {
            ...
            public void loadImage(ImageView imageView, String url) {
                Picasso.with(BaseMessagesActivity.this).load(url).into(imageView);
            }
        };
    }
