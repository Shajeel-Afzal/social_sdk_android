...
import com.sumatodev.social_chat_sdk.chatkit_ui.commons.ViewHolder;
...
import com.sumatodev.social_chat_sdk.chatkit_ui.utils.DateFormatter;
import com.sumatodev.social_chat_sdk.chatkit_ui.utils.RoundedImageView;
    ...
    * */
    ...
    public static class IncomingImageMessageViewHolder<MESSAGE extends MessageContentType.Image>
        ...
        public void onBind(MESSAGE message) {
            ...
            if (image != null && imageLoader != null) {
                Log.d("MessageHolder: ", "1st called");
    ...
    public static class OutcomingImageMessageViewHolder<MESSAGE extends MessageContentType.Image>
        ...
        public void onBind(MESSAGE message) {
            super.onBind(message);
            if (image != null && imageLoader != null) {
                Log.d("MessageHolder: ", "2nd called");
                imageLoader.loadImage(image, message.getImageUrl());
            }
    ...
    public abstract static class BaseIncomingMessageViewHolder<MESSAGE extends IMessage>
        ...
        public void onBind(MESSAGE message) {
            if (time != null) {
                time.setText(DateFormatter.format(message.getCreatedAt(), DateFormatter.Template.STRING_DAY_MONTH));
            }

            if (userAvatar != null) {
                Log.d("MessageHolder: ", "3rd called");
                ...
                if (isAvatarExists) {
                    imageLoader.loadImage(userAvatar, message.getUser().getId());
                }
            }
        }
